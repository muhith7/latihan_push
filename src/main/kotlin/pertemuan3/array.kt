...
fun main(){
    ...
    var namaKelompok = arrayOf("muhith",19,true,"aji")//Array Bebas Any bisa menampung semua jenis type data
    ...
    arrayOfnull[1]="abdul muhith nawawi"
    arrayOfnull[2]= null
    ...
    kumpulanString.set(0,"abdul")
    kumpulanString[1]= "Abdul"
    println(kumpulanString[1])
    println(kumpulanString[0])


    // Imutable List tidak dapat dirubah
    val myBucketList = listOf("hiking","susrfing","go to bali")
    ...
    planningList.add("Workout")//menambahkan value list
